...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src/page/tetris/components/tetris.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		ready: function ready() {
			...
			new _hammerjs2.default((0, _dom.query)('.play')).on('tap', function (e) {
			...
			new _hammerjs2.default((0, _dom.query)('.msg')).on('tap', function (e) {
				vm.toggleMsg();
			});
		}
	};
...
/***/ function(module, exports) {
	...
	*/
	...
	var css = function css(node, attr, val, context) {
	    var attrs = {},
	        nodes = [];
	...
	// 添加class
	var addClass = function addClass(node, cls, type, context) {
	    var nodes = [];
	...
	// 删除class
	var removeClass = function removeClass(node, cls, context) {
	    return addClass(node, cls, 'remove', context);
	};

	var on = function on(node, type, fn, context) {
	    var nodes = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/page/tetris/components/chessboard.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-1ec74612/chessboard.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1ec74612&scoped=true!./../../../../node_modules/stylus-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./chessboard.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1ec74612&scoped=true!./../../../../node_modules/stylus-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./chessboard.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".chessboard[_v-1ec74612] {\n  width: auto;\n  text-align: center;\n  padding: 10px;\n}\n.chessboard table[_v-1ec74612] {\n  border-collapse: collapse;\n  background: #eee;\n  margin: 0 auto;\n}\n.chessboard table td[_v-1ec74612] {\n  width: 20px;\n  height: 20px;\n  border: 1px solid #fff;\n  font-size: 9px;\n  text-align: center;\n  color: #ccc;\n  padding: 0 0 0 1px;\n}\n.chessboard table td.active[_v-1ec74612] {\n  background: #808080;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<div class=\"chessboard\" _v-1ec74612=\"\">\n\t<table _v-1ec74612=\"\">\n\t\t<tbody _v-1ec74612=\"\"><tr v-for=\"row in rows\" _v-1ec74612=\"\">\n\t\t\t<td v-for=\"cell in row\" :class=\"cell.val == 1 ? 'active' : ''\" _v-1ec74612=\"\"></td>\n\t\t</tr>\n\t</tbody></table>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/page/tetris/components/score.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-0eb729de&scoped=true!./../../../../node_modules/stylus-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./score.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-0eb729de&scoped=true!./../../../../node_modules/stylus-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./score.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "h1[_v-0eb729de] {\n  margin: 20px auto 0 auto;\n  font-size: 14px;\n  padding: 6px 0;\n  text-align: center;\n  border-radius: 3px;\n  width: 65px;\n  color: #f60;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/page/tetris/components/handles.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-bfd33cec/handles.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-bfd33cec&scoped=true!./../../../../node_modules/stylus-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./handles.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-bfd33cec&scoped=true!./../../../../node_modules/stylus-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./handles.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".control[_v-bfd33cec] {\n  padding: 5px 0 0 0;\n  margin: 0 1em;\n}\n.control .control-content[_v-bfd33cec] {\n  width: 200px;\n  height: 120px;\n  background: #fff;\n  margin: 0 auto;\n}\n.control table[_v-bfd33cec] {\n  border-collapse: collapse;\n  width: 100%;\n}\n.control table td[_v-bfd33cec] {\n  border: 1px solid #fff;\n  vertical-align: middle;\n  width: 33.33%;\n  text-align: center;\n  color: #fff;\n}\n.control table td.roate[_v-bfd33cec],\n.control table td.down[_v-bfd33cec] {\n  height: 50px;\n}\n.control table td.touch-style[_v-bfd33cec] {\n  background: #fff;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		ready: function ready() {
			...
			new _hammerjs2.default(document.querySelector('body')).on('swipeleft swiperight swipedown swipeup', function (e) {
			...
			}).get('swipe').set({ direction: _hammerjs2.default.DIRECTION_ALL });

			new _hammerjs2.default(document.querySelector('.btn.left')).on('tap', function () {
				if (vm.status !== 'playing') return;
				vm.move('left');
			});
			new _hammerjs2.default(document.querySelector('.btn.right')).on('tap', function () {
				if (vm.status !== 'playing') return;
				vm.move('right');
			});
			new _hammerjs2.default(document.querySelector('.btn.down')).on('tap', function () {
				if (vm.status !== 'playing') return;
				vm.move('down');
			});
			new _hammerjs2.default(document.querySelector('.btn.roate')).on('tap', function () {
				if (vm.status !== 'playing') return;
				vm.roate();
			});
...
/***/ function(module, exports) {
	...
	module.exports = "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<div class=\"control\" _v-bfd33cec=\"\">\n\t<table _v-bfd33cec=\"\">\n\t\t<tbody _v-bfd33cec=\"\"><tr _v-bfd33cec=\"\">\n\t\t\t<td class=\"btn left\" rowspan=\"2\" _v-bfd33cec=\"\">←</td>\n\t\t\t<td class=\"btn roate\" _v-bfd33cec=\"\"></td>\n\t\t\t<td class=\"btn right\" rowspan=\"2\" _v-bfd33cec=\"\">→</td>\n\t\t</tr>\n\t\t<tr _v-bfd33cec=\"\">\n\t\t\t<td class=\"btn down\" _v-bfd33cec=\"\">↓</td>\n\t\t</tr>\n\t</tbody></table>\n</div>\n";
